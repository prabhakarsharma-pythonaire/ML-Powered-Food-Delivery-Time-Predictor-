...
# from src.config.configuration import PREPROCESSING_OBJ_FILE, TRANSFORMATION_TRAIN_FILE_PATH, TRANSFORMATION_TEST_FILE_PATH, FEATURE_ENGINEERING_OBJ_FILE_PATH
#
#
# # FE
# # Data transformation
...
#
#             df.drop(['Delivery_person_ID', 'Restaurant_latitude', 'Restaurant_longitude', 'Delivery_location_latitude',
#                      'Delivery_location_longitude',
...
#     transform_train_path = TRANSFORMATION_TRAIN_FILE_PATH
...
#
#             logging.info("Optaining Feature engineering object")
...
#
#             #Transofrming using preprocessor obj
#
...
class DataTransformationConfig():  # first modofication
    ...
    transformed_train_path = TRANSFORMATION_TRAIN_FILE_PATH
    transformed_test_path = TRANSFORMATION_TEST_FILE_PATH
    feature_eng_obj_path = FEATURE_ENGINEERING_OBJ_FILE_PATH
